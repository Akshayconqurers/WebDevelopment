...
const Signup = () => {
  ...
  return (
    <div>
  <div className="mt-7 bg-white container mx-auto border max-w-[40%] border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
        ...
        <div className="grid gap-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              className="py-2.5 sm:py-3 px-4 block w-full border-white-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-30 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required aria-describedby="email-error" />
